...
async function sendOrderConfirmation(orderDetails) {
  ...
  const htmlContent = `
    <div style="font-family: Arial, sans-serif; max-width: 800px; margin: 0 auto; background-color: #ffffff; color: #000000; padding: 40px;">
      ...
      <h2 style="color: #666666; font-size: 16px; margin-bottom: 20px;">Order Details:</h2>
      ...
      <p style="color: #666666; margin-bottom: 30px;">
        ...
        <a href="mailto:sleeve.support@gmail.com" style="color: #000000; text-decoration: none;">sleeve.support@gmail.com</a>
      </p>
      
      <div style="margin-top: 40px; padding-top: 20px; border-top: 1px solid #e0e0e0; text-align: center; color: #666666;">
